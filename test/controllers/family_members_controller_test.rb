...
class FamilyMembersControllerTest < ActionController::TestCase
  ...
  test "should create family_member" do
    assert_difference('FamilyMember.count') do
      post :create, family_member: { family_member_id: @family_member.family_member_id, user_id: @family_member.user_id }
    end
  ...
  test "should update family_member" do
    patch :update, id: @family_member, family_member: { family_member_id: @family_member.family_member_id, user_id: @family_member.user_id }
    assert_redirected_to family_member_path(assigns(:family_member))
  end
